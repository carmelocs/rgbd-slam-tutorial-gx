...
int main( int argc, char** argv )
{
    ...
    //读取图像
    frame1.rgb = cv::imread( "/home/shuai_cheng/Documents/Repositories/data/rgbd-slam-tutorial-gx/rgb1.png" );
    frame1.depth = cv::imread( "/home/shuai_cheng/Documents/Repositories/data/rgbd-slam-tutorial-gx/depth1.png", -1);
    frame2.rgb = cv::imread( "/home/shuai_cheng/Documents/Repositories/data/rgbd-slam-tutorial-gx/rgb2.png" );
    frame2.depth = cv::imread( "/home/shuai_cheng/Documents/Repositories/data/rgbd-slam-tutorial-gx/depth2.png", -1 );
